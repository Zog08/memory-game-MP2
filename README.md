...
![Wireframe Desktop Start](docs/wireframes/wireframe-index-desktop.png)

![Wireframe Mobile Start](docs/wireframes/wireframe-index-mobile.png)

</details>

<details><summary>Start Page, How To Play</summary>

![Wireframe Desktop Start](docs/wireframes/wireframe-howtoplay-desktop.png)

![Wireframe Mobile Start](docs/wireframes/wireframe-howtoplay-mobile.png)

</details>

<details><summary>Start Page, Click To Play</summary>

![Wireframe Desktop Play](docs/wireframes/wireframe-clicktoplay-desktop.png)

![Wireframe Mobile Play](docs/wireframes/wireframe-clicktoplay-mobile.png)

</details>

<details><summary>Game Page</summary>

![Wireframe Desktop Game](docs/wireframes/wireframe-game-desktop.png)

![Wireframe Mobile Game](docs/wireframes/wireframe-game-mobile.png)

</details>

<details><summary>End Page</summary>

![Wireframe Desktop End]("docs/wireframes/wireframe-end-desktop.png)

![Wireframe Mobile End](docs/wireframes/wireframe-end-mobile.png)

</details>

<details><summary>404 Page</summary>

![Wireframe Desktop 404](docs/wireframes/wireframe-404-desktop.png)

![Wireframe Mobile 404](docs/wireframes/wireframe-404-mobile.png)
...
![Initial Colour Picker](docs/colours/picker-screenshot-colors.webp)
</details>

<details><summary>Initial Colour Palette</summary>

![Initial Colour Palette](docs/colours/picker-palette-colors.webp)

</details>

<details><summary>Adjusted Final Colour Palette</summary>

![Final Colour Palette](docs/colours/stardew-valley-final.webp)
...
* [EZgif](http://ezgif.com)
  * Used to convert small .mov files to .gif in TESTING docs
...
<details><summary>Favicon Screenshots</summary>

* **Tab icon for Chrome browsers**
![Tab Icon Chrome](docs/features/features-tabicon-chrome.png)

* **Tab icon for Safari browsers**
![Tab Icon Safari](docs/features/features-tabicon-safari.png)

</details>

* I included a custom Favicon for the site using the 'Junimo' image from Stardew Valley. This helped to build the brand and continue the site design in the user's browser tab. It is also the same as the custom cursor hover over the playing cards.
* **User stories covered: 4, 6, 8, 9, 11**

#### **Logo**

<details><summary>Logo Header Screenshots</summary>

![Logo Header](docs/features/features-logoheader.png)
...
<details><summary>Welcome Page Screenshots</summary>

![Welcome Initial Menu](docs/features/features-index-welcome.png)
*Welcome page initial menu*

![Welcome How To Play Menu](docs/features/features-index-welcome-howtoplay.png)
*Welcome page - 'How To Play' accordion*

![Welcome Click to Play Menu](docs/features/features-index-welcome-clicktoplay.png)
...
![Game Area Initially](docs/features/features-gamearea-start.png)
**Game page at load**

![Game Area In Play](docs/features/features-gamearea-inplay.png)
**Game page in play**
...
![End Page on Load](docs/features/features-endpage.png)
**End Results Page, after playing, upon load**

![End Page on Enter Name](docs/features/features-endpage-entername.png)
**End Page form with name typed in**

![End Page Hi Scores](docs/features/features-endpage-hiscores.png)
...
![404 On Load](docs/features/features-404.png)
**404 Page**
...
* Larger, more general tutorials for required code:
  * [CodeSketchLab youtube playlist](https://youtu.be/eMhiMsEC9Uk?si=vu4F7Uf1qoIUBhz6): Memory game tutorial, helped with datasets, grid layout and shuffle, lockboard function and general tips for memory game success
...
[Go to Top](#stardew-valley-themed-memory-game)
